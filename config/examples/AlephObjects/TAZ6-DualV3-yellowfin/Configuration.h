...
#define STRING_CONFIG_H_AUTHOR "(jjaeggli)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_RAMBO // <-- changed
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "LulzBot TAZ 6" // <-- changed
...
#define TEMP_SENSOR_1 5 // <-- changed
...
#define HEATER_1_MAXTEMP 305 // <-- changed
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  47.45 // <-- changed
    #define DEFAULT_Ki   4.83 // <-- changed
    #define DEFAULT_Kd 116.63 // <-- changed
  #endif
#endif // PIDTEMP
...
#define E1_DRIVER_TYPE A4988 // <-- changed
 ...
 */
#define DISTINCT_E_FACTORS // <-- changed
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5, 100.5, 1600, 760, 760 } // <-- changed
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25, 25 } // <-- changed
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 100, 9000, 9000 } // <-- changed
...
#define DEFAULT_RETRACT_ACCELERATION  3000   // <-- changed: E acceleration for retracts
 ...
 */
#define Z_MIN_PROBE_PIN SERVO0_PIN // <-- changed: Pin 32 is the RAMPS default
 ...
 */
#define FIX_MOUNTED_PROBE // <-- changed
...
#define X_BED_SIZE 279 // <-- changed
#define Y_BED_SIZE 280 // <-- changed

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -26 // <-- changed
#define Y_MIN_POS -27 // <-- changed
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS 296 // <-- changed
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // TAZ6 parameters for probe bed position are replaced PROBING_MARGIN_*
  // parameters in Configuration_adv.h
...
#define MANUAL_Z_HOME_POS 5.5 // <-- changed
...
#define Z_SAFE_HOMING // <-- changed
  ...
  #define Z_SAFE_HOMING_X_POINT -26  // <-- changed: X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 258  // <-- changed: Y point for Z homing
#endif
...
#define PREHEAT_1_TEMP_HOTEND  // <-- changed
...
#define NOZZLE_PARK_FEATURE // <-- changed
  ...
  #define NOZZLE_PARK_POINT {100, 295, 20 } // <-- changed
...
#define NOZZLE_CLEAN_FEATURE // <-- changed
  ...
  #define NOZZLE_CLEAN_START_POINT { -26, 95, 1 } // <-- changed
  #define NOZZLE_CLEAN_END_POINT   { -26, 25, 1 } // <-- changed
...
; #define LULZBOT_EXTRUDER_FAN_ON_PIN_6 // <-- changed
; #define LULZBOT_NO_MOVE_ON_TOOLHEAD_CHANGE // <-- changed
; #define LULZBOT_SWAP_EXTRUDERS // <-- changed
; #define LULZBOT_G29_ENDS_ON_BACK_LEFT_CORNER // <-- changed
; #define LULZBOT_TOOLHEAD_M115_TYPE "DualExtruder v3" // <-- changed
...
; #define LULZBOT_LCD_MACHINE_NAME "TAZ 6" // <-- changed
; #define LULZBOT_LCD_TOOLHEAD_NAME "Dual Extruder 3" // <-- changed
...
;  */
; #define MAX_PROBE_Y 291 // <-- changed
; #define MAX_PROBE_X 275 // <-- changed
; #define MIN_PROBE_Y -9 // <-- changed
