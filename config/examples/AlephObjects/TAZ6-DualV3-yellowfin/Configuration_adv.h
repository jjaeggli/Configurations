 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 15        // <-- changed: Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 30    // <-- changed: Degrees Celsius
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 40                // <-- changed: Seconds
  #define WATCH_TEMP_INCREASE 10              // <-- changed: Degrees Celsius
#endif
...
#define USE_CONTROLLER_FAN // <-- changed
  ...
  #define CONTROLLER_FAN_PIN FAN_PIN_2   // <-- changed: Set a custom pin for the controller fan
...
#define FAN_MAX_PWM 128 // <-- changed
...
#define ENDSTOPS_ALWAYS_ON_DEFAULT // <-- changed
...
#define DIGIPOT_MOTOR_CURRENT { 175, 175, 200, 160, 160 } // <-- changed: Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
#define BABYSTEPPING // <-- changed
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // <-- changed: Combine M851 Z and Babystepping
    ...
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // <-- changed: dEnable graphical overlay on Z-offset editor
  #endif
#endif
 ...
 */
// LulzBot TAZ6 Yellowtail positions: { -10, 275, -9, 291 }
#if PROBE_SELECTED && !IS_KINEMATIC
  #define PROBING_MARGIN_LEFT -10 // <-- changed
  #define PROBING_MARGIN_RIGHT  4 // <-- changed
  #define PROBING_MARGIN_FRONT -9 // <-- changed
  #define PROBING_MARGIN_BACK -11 // <-- changed
#endif
